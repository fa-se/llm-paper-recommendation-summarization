...
class Work:
    def __init__(self, pyalex_work: pyalex.Work):
        ...
        for topic in pyalex_work['topics']:
            topic_id = int(
                topic['id'].split('T')[-1])  # OpenAlex returns ids as URL in the form 'https://openalex.org/T12345'
...
def get_works_by_topics(topic_ids: [int], published_after: datetime.date, n_max: int = 2000) -> list[Work]:
